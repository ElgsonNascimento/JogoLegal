...
public class TelaCadastro extends JFrame {
    ...
    public TelaCadastro(SistemaLogin sistema) {
        ...
        JLabel lblSenha = new JLabel("Senha (8+ caracteres e 1 especial: !@#$%...)");
        ...
        JPanel painelTipo = new JPanel(new GridLayout(1, 2, 8, 0));
        painelTipo.setBackground(new Color(24, 26, 27));
        painelTipo.setBounds(100, 256, 300, 60);
        painelTipo.add(rbUsuario);
        painelTipo.add(rbCriador);

        JButton btnCadastrar = new JButton("CADASTRAR E ENTRAR");
        btnCadastrar.setBounds(100, 335, 300, 45);
        ...
        btnVoltar.setBounds(175, 388, 150, 25);
        ...
        btnCadastrar.addActionListener(e -> {
            ...
            String tipo  = rbCriador.isSelected() ? "criador" : "usuario";
