...
public class TelaCarrinho extends JFrame {
    ...
    public TelaCarrinho(String nome, SistemaLogin sistema,
        ...
        Runnable atualizarTotal = () -> {
            double tot = 0;
            if (carrinhoJogos != null) for (Jogo j : carrinhoJogos) tot += j.getPreco();
            lblTotal.setText(String.format("Total: R$ %.2f", tot));
        };
        ...
        btnFinalizar.addActionListener(_ -> {
            ...
            dispose();
            new TelaPagamento(nome, sistema, carrinhoJogos, bibliotecaJogos, telaUsuario);
        });
